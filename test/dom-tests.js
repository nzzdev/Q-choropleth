...
lab.experiment("annotations", () => {
  ...
  it("annotations on narrow map have correct coordinates (geographic)", async () => {
    ...
    expect(annotationLinesAsObjects).to.be.equal([
      { x1: '123.06', y1: '-8', x2: '123.06', y2: '76.73' },
      { x1: '28.01', y1: '-8', x2: '28.01', y2: '189.17' },
      { x1: '223.46', y1: '377.42', x2: '223.46', y2: '128.32' },
      { x1: '63.77', y1: '377.42', x2: '63.77', y2: '318.56' },
      { x1: '168.48', y1: '377.42', x2: '168.48', y2: '330.54' }
    ]);
  });
  ...
  it("annotations on wide map have correct coordinates (geographic)", async () => {
    ...
    expect(annotationLinesAsObjects).to.be.equal([
      { x1: '183.21', y1: '-8', x2: '183.21', y2: '114.23' },
      { x1: '-8', y1: '281.64', x2: '41.71', y2: '281.64' },
      { x1: '332.69', y1: '191.05', x2: '412.96', y2: '191.05' },
      { x1: '94.94', y1: '558', x2: '94.94', y2: '474.28' },
      { x1: '250.84', y1: '558', x2: '250.84', y2: '492.11' }
    ]);
  });
